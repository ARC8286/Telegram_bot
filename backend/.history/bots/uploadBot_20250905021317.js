...
class UploadBot {
    constructor() {
        this.botToken = process.env.UPLOAD_BOT_TOKEN;
        this.botUsername = process.env.UPLOAD_BOT_USERNAME;
...
/cancel - Cancel current operation`);
        ...
        try {
            switch (state.step) {
                ...
                case 'awaiting_channel':
                    ...
                    state.data.channel = process.env.MOVIES_CHANNEL_ID;
    ...
    async handleMovieFileUpload(ctx, userId) {
        ...
        try {
            ...
            // Generate deep link
            const deepLink = `https://t.me/${process.env.BOT_USERNAME}?start=${contentId}`;
    ...
    // Series creation methods would be similar to your existing implementation
    // but adapted for the new database structure
}
